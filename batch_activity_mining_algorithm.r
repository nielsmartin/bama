...
detect_batching_behavior <- function(activity_log, act_seq_tolerated_gap_list,  timestamp_format = "yyyy-mm-dd hh:mm:ss", numeric_timestamps = TRUE, log_and_model_based,
  ...
  # Remove rows included in a task-based concurrent/sequential subprocess (otherwise they are duplicated in the output as batch_type concurrent is included both in activity_log_ss1 and activity_log_ss2)
